...
<body>
	...
	<section>
		...
		<p>Instead, try to focus on getting the best you can first time, and then hitting a cache you created after that.</p>
	</section>
	<hr id="cdns-are-only-for-common-libraries-like-jquery">
	<section>
		<h2>CDNs are only for common libraries like jQuery</h2>
		<p>Not jsDelivr, or CDNJS for that matter. These two allow submission of any library (CDNJS is stricter, requiring some level of popularity). Combine that with the file-combiner found at jsDelivr, and you've got yourself one file taking care of several requests that's the same size as if they had been loaded separately.</p>
